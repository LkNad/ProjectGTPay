document.addEventListener('DOMContentLoaded', function() {
	...
	let onlineMarketView = 'platform'; // 'platform' или 'requests'
  ...
  if (currentMarket === 'rental') {
	...
	function initOnlineMarket() {
		...
		omContainer.innerHTML = `
			<div class="online-market-view-toggle" style="display:flex;gap:10px;margin-bottom:15px;justify-content:center;">
				<button id="om-view-platform-btn" class="om-view-btn active" style="padding:8px 16px;background:#4CAF50;color:white;border:none;border-radius:4px;cursor:pointer;font-size:14px;">Платформа</button>
				<button id="om-view-requests-btn" class="om-view-btn" style="padding:8px 16px;background:#434343;color:#fff;border:none;border-radius:4px;cursor:pointer;font-size:14px;">Мои запросы</button>
			</div>
		...
		// View toggle buttons
		document.getElementById('om-view-platform-btn').addEventListener('click', function() {
			onlineMarketView = 'platform';
			document.querySelectorAll('.om-view-btn').forEach(b => b.classList.remove('active'));
			this.classList.add('active');
			this.style.background = '#4CAF50';
			document.getElementById('om-view-requests-btn').style.background = '#434343';
			document.getElementById('om-platform-container').style.display = 'block';
			document.getElementById('om-requests-container').style.display = 'none';
			renderPlatformGrid();
		});
		
		document.getElementById('om-view-requests-btn').addEventListener('click', function() {
			onlineMarketView = 'requests';
			document.querySelectorAll('.om-view-btn').forEach(b => b.classList.remove('active'));
			this.classList.add('active');
			this.style.background = '#4CAF50';
			document.getElementById('om-view-platform-btn').style.background = '#434343';
			document.getElementById('om-platform-container').style.display = 'none';
			document.getElementById('om-requests-container').style.display = 'block';
			renderMyRequests();
		});
